...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="forum.php">
                <div class="sidebar-brand-icon ">
                    <!-- <i class="fas fa-laugh-wink"></i> -->
                    <h1 style="text-indent:-999999px;background:url('img/logo1.png');background-size: 70px 70px;width:70px;
                        height: 70px;">
                        Logo here
                    </h1>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php">ViewUsers</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseDepartaments" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="create_departaments.php">CreateDepatments</a>
                        <a class="collapse-item" href="displayDepartments.php">Afisare Departamente</a>
                        <!-- <a class="collapse-item" href="utilities-border.php">Borders</a>
                        <a class="collapse-item" href="utilities-animation.php">Animations</a>
                        <a class="collapse-item" href="utilities-other.php">Other</a> -->
                    </div>
...
<script>
    $('#buttonLogout').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: 'http://localhost/backend_travel/users/logout.php',
            data: [],
    ...
    $('#alertsDropdown').on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: 'http://localhost/backend_travel/users/postInNavBar.php',
            data: {
                user_id: user_id
            },
            success: function(response) {
                ...
                response.data.forEach(function(dep) {
                    ...
                    var htmlString = "";
                    console.log(dep.id_user);
                    console.log(dep.id_post);
                    ...
                    if (dep.id_user_from_lastName == "") {
                        ...
                        htmlString = "<a class=\"dropdown-item d-flex align-items-center dynamic-item-post\" href=\"uniquePost.php?id_post=" + dep.id_post + "&id_user=" + dep.id_user + "\" data-user_id='" + dep.id_post + "' > " +
                            ...
                            "<img class='img-profile rounded-circle'src = '" + dep.profile_photo + "'alt = 'img/undraw_profile_2.svg' class='img - fluid' > " +
                            "        </div>" +
                            "    </div>" +
                            "    <div>" +
                            "        <div class=\"small text-gray-500\">" + dep.firstName + " " + dep.lastName + " " + dep.dateTime + "</div>" +
                            dep.description +
                            "    </div>" +
                            "</a>";
                    } else {
                        htmlString = "<a class=\"dropdown-item d-flex align-items-center  dynamic-item-post\" href=\"uniquePost.php?id_post=" + dep.id_post + "&id_user=" + dep.id_user + "\" data-user_id='" + dep.id_post + "'>" +
                            ...
                            "    </div>" +
                            "    <div>" +
                            "        <div class=\"small text-gray-500\">" + dep.firstName + " " + dep.lastName + " -" + dep.id_user_from_lastName + " " + dep.data_share + "</div>" +
                            dep.description +
                            "    </div>" +
                            "</a>";
                    }
    ...
    $('#messagesDropdown').on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: 'http://localhost/backend_travel/users/commentsDropdown.php',
            data: {
                user_id: user_id
            },
            success: function(response) {
                ...
                response.data.forEach(function(dep) {
                    console.log(dep.id_post);
                    var start_actual_time = dep.dateTime;
                    ...
                    // var formattedHours = diff.getHours() + " days ";
                    // var formattedMinutes = diff.getMinutes() + " min";
                    // var formattedSeconds = diff.getSeconds() + " sec"
                    // if (diff.getHours() == "0") {
                    //     formattedHours = "";
                    // }
                    // var formatted = formattedHours + formattedMinutes;
                    ...
                    if (dep.id_user_from_lastName == "") {
                        $nume_from = "";
                        htmlString = '<a class="dropdown-item d-flex align-items-center dynamic-item" href="chat.php?id_post=' + dep.id_post + '">' +
                            '<div class="dropdown-list-image mr-3">' +
                            '<img class="rounded-circle" src="' + dep.profile_photo + '" alt="...">' +
                            '<div class="status-indicator bg-success"></div>' +
                            '</div>' +
                            '<div class="font-weight-bold">' +
                            '<div class="text-truncate">' + dep.commentDescription + '</div>' +
                            '<div class="small text-gray-500">' + dep.lastName + ' ' + dep.firstName + ' · ' + formatted + '</div>' +
                            '</div>' +
                            '</a>';
                    } else {
                        htmlString = '<a class="dropdown-item d-flex align-items-center dynamic-item" href="chat.php?id_post=' + dep.id_post + '">' +
